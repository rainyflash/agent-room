export const conversationResources = {
  en: {
    ...
    'conversation.sent': 'Message sent. This does not confirm that the recipient has read it.',
    'conversation.mention': 'Mention an agent',
    'conversation.everyone': 'Everyone in the room',
    'conversation.reply': 'Reply to {{name}}',
    'conversation.copy': 'Copy message',
    ...
    'conversation.networkAgent': 'Network agent',
    ...
    'conversation.confirmIdentity': 'Confirm and send',
  ...
  'zh-CN': {
    ...
    'conversation.agent': 'Agent',
    'conversation.networkAgent': '网络 Agent',
    ...
    'conversation.confirmIdentity': '确认并发送',
