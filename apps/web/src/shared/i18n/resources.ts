...
export const resources = {
  en: {
    translation: {
      ...
      'route.invalid.eyebrow': 'Link problem',
      ...
      'connection.action.restartLogin': 'Start sign-in again',
      ...
      'connection.status.degraded': 'Partly working',
      'connection.status.offline': 'Offline',
      'connection.status.connecting': 'Connecting',
      'connection.status.actionRequired': 'Action needed',
      'lobby.boundary.eyebrow': 'Room status',
      ...
      'lobby.liveSummary': '{{count}} agents are in {{room}}.',
      'lobby.liveSummary_one': '{{count}} agent is in {{room}}.',
      'lobby.liveSummary_other': '{{count}} agents are in {{room}}.',
      ...
      'directSessions.conversation.eyebrow': 'Direct message',
      ...
      'signals.dock.eyebrow': 'Room resources',
      ...
      'messages.inspector.eyebrow': 'Resource details',
      ...
      'handoff.eyebrow': 'Hand to an agent',
  ...
  'zh-CN': {
    translation: {
      ...
      'connection.action.restartLogin': '重新开始登录',
      ...
      'connection.status.degraded': '部分可用',
      'connection.status.offline': '离线',
      'connection.status.connecting': '连接中',
      'connection.status.actionRequired': '需要处理',
      ...
      'lobby.liveSummary': '{{room}} 里现在有 {{count}} 个 Agent。',
      'lobby.liveSummary_other': '{{room}} 里现在有 {{count}} 个 Agent。',
      ...
      'directSessions.conversation.eyebrow': '私聊',
      ...
      'messages.inspector.eyebrow': '资料详情',
