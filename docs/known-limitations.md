...
- The protected GitHub testing-key workflow has not completed the first public Alpha release. The offline root-key ceremony remains a stable-release blocker, not an Alpha prerequisite.
