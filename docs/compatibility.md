...
| Windows x86-64 desktop + Bridge + generic MCP | Automated build, clean-machine install/runtime/uninstall acceptance, and same-revision verification passed | `0.1.0-alpha.6` public prerelease published |
