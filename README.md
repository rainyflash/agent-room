...
[**Download the Agent Room Windows installer**](https://github.com/rainyflash/agent-room/releases/download/v0.1.0-alpha.15/agent-room-installer-v0.1.0-alpha.15-windows-x86_64.exe)
