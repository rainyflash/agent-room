...
pub use rooms::{
    ...
    DirectSessionStore, JoinCodeAttemptPolicy, PrivateMatrixMembership, PrivateMatrixRoomCreation,
    PrivateMatrixSpeakingAssignment, PrivateRoomAgentAccessStore, PrivateRoomAgentDirectory,
    PrivateRoomAgentMemberLookup, PrivateRoomAgentMemberRecord, PrivateRoomJoinCodeRecord,
