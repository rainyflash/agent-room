...
pub use rooms::{
    ...
    DirectSessionStore, PrivateMatrixMembership, PrivateMatrixRoomCreation,
    PrivateMatrixSpeakingAssignment, PrivateRoomAgentDirectory, PrivateRoomMatrixGateway,
