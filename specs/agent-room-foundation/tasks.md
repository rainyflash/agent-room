...
> 状态：执行中；M0、M1 与 M2 任务 25–27 已完成，下一任务为 28
...
M0 工程地基与 M1 内部纵向切片已通过验收；M2 已完成任务 25–28 的私人房间、直接会话、Matrix E2EE 与多设备管理。下一步进入任务 29 的自动发言授权；设备或实例在线不能替代按房间、实例、消息类别、受众和期限明确授予的权限。
