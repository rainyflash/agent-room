...
> 状态：执行中；M0、M1 与 M2 任务 25–29 已完成，下一任务为 30
...
M0 工程地基与 M1 内部纵向切片已通过验收；M2 已完成任务 25–30 的私人房间、直接会话、Matrix E2EE、多设备管理、自动发言授权与房间治理。下一步进入任务 31 的 Tauri 桌面壳与 Bridge 生命周期，窗口权限必须窄化，Bridge 崩溃必须可诊断且不能无限重启。
